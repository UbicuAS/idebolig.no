...
def omossside(nr: int) -> str:
    return f"""<div class="fb-info">
      ...
      <p class="fb-brod">Idébolig er en boligbygger med base på Hamar og i
        Lørenskog. Vi kombinerer tidløs design med praktiske planløsninger,
        og legger vekt på at hjemmene vi bygger skal være både vakre å se på
        og gode å leve i — år etter år.</p>
